...
/**
 * A simplified navbar for auth pages (login/register).
 * Shows only the logo and Login/Get Started buttons.
 * No "Features", "Why Us", "About", etc.
 */
    ...
    return (
        <nav
            style={{
                ...
                boxShadow:
                    "0 12px 40px rgba(15, 23, 42, 0.05), 0 1px 2px rgba(15, 23, 42, 0.02)",
                padding: "10px 24px",
                display: "flex",
                alignItems: "center",
