-- 1. Better Auth tables are generated by the Better Auth CLI.
-- Run this against the same Supabase Postgres database used by SUPABASE_DB_URL:
...
-- 2. Table: profiles (Terkoneksi dengan Better Auth public."user")
...
-- 3. Table: financial_records (Data finansial terkini user)
...
-- 4. Table: retirement_plans (Rencana dan hasil kalkulasi Aktuaria)
...
-- 5. Table: risk_profiles (History/Riwayat assessment profil risiko)
